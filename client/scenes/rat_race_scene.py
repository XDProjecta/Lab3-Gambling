...
class RaceScene(tk.Frame):
    ...
    def build(self):
        ...
        tk.Button(ctrl, text="Enviar posiciones", command=self.send_snapshot, bg="#2ef0f0").pack(side="left", padx=6)
    ...
    def send_snapshot(self):
        # envío manual de todas las posiciones
        if self.net and getattr(self.net, "connected", False):
